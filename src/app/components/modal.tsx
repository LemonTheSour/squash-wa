...
const modalStyle1 = "items-center pt-10 bg-white rounded-lg w-1/2 relative";
const modalStyle2 = "items-center pt-10 bg-white rounded-lg w-1/2 relative";

export default function Modal({ children, isOpen, onClose }: ModalProps) {
  return (
    isOpen && (
      <div className="flex justify-center items-center w-screen h-screen fixed inset-0 z-30 bg-slate-400/25">
        <div className={isOpen ? modalStyle2 : modalStyle1}>
